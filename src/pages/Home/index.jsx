    ...
    const fetchFilterOptions = () => {
        ...
        axios
            ...
            .then((res) => {
                ...
                const moods =
                    res.data.payload.moods.length > 0
                        ? res.data.payload.moods
                        : [
                              { id: 1, mood: "happy" },
                              { id: 2, mood: "sad" },
                              { id: 3, mood: "excited" },
            ...
            .then((res) => {
                ...
                if (selectedMood && selectedCountry) {
                    fetchedCapsules = fetchedCapsules.filter((capsule) => {
                        return (
                            capsule.location &&
                            capsule.location.country_name === selectedCountry
                        );
                    });
                }
    ...
    return (
        <div className="home-page">
            ...
            <div className="filters-container">
                ...
                <div className="filters-row">
                    ...
                    <div className="filter-group">
                        ...
                        >
                            ...
                            {filterOptions.locations.countries.map(
                                (country, index) => (
                                    <option
                                        key={index}
                ...
                {!loading && (
                    <div className="results-count">{getResultsText()}</div>
                )}
            </div>
                ...
                {loading ? (
                    ...
                    capsules.map((capsule) => (
                        <Capsule
                            ...
                            profileImage=""
                            mediaImages={
                                capsule.media_url ? [capsule.media_url] : []
                            }
                        />
                    ))
                ) : (
